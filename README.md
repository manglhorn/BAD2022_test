...
Ви практично не обмежені у виборі методу та способу вирішення задачі. Це означає, що ви можете використовувати будь-які засоби, методи, підходи (крім наведених нижче). Тобто Ви можете, наприклад, написати програму причому будь-якою відомою вам мовою програмування. Або можете використовувати наявні програми/утиліти. Очевидно, що ви можете використовувати набори статистичних готових класів/функцій/бібліотек, але це не найкращий варіант.
